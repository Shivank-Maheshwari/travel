...
?>
Hello<?php if(isset($_SESSION['pmusername'])){echo ' '.htmlentities($_SESSION['pmusername'], ENT_QUOTES, 'UTF-8');} ?>,<br />
...
$nb_new_pm = mysql_fetch_array(mysql_query('select count(*) as nb_new_pm from pm where ((user1="'.$_SESSION['pmuserid'].'" and user1read="no") or (user2="'.$_SESSION['pmuserid'].'" and user2read="no")) and id2="1"'));
...
?>
		...
		<div class="foot"><a href="http://">Travelbugs</a></div>
	</body>
</html>