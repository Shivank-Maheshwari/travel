...
if($dn1['user1']==$_SESSION['pmuserid'] or $dn1['user2']==$_SESSION['pmuserid'])
{
//The discussion will be placed in read messages
if($dn1['user1']==$_SESSION['pmuserid'])
{
...
if(isset($_POST['message']) and $_POST['message']!='')
{
	...
	if(mysql_query('insert into pm (id, id2, title, user1, user2, message, timestamp, user1read, user2read)values("'.$id.'", "'.(intval(mysql_num_rows($req2))+1).'", "", "'.$_SESSION['pmuserid'].'", "", "'.$message.'", "'.time().'", "", "")') and mysql_query('update pm set user'.$user_partic.'read="yes" where id="'.$id.'" and id2="1"'))
	{
?>
...
?>
		<div class="foot"><a href="list_pm.php">Go to my personnal messages</a> - <a href="http://">Travelbugs</a></div>
	</body>
</html>