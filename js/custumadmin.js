...
{
document.frm.submit.onclick = function () { sendRequest(); };
};
...
$.Notify({
                                    ...
                                    position: 'top-right',
									background: 'red',
                                    content: "Choose another E-mail id."
                                })
...
$.Notify({
                                    ...
                                    position: 'top-right',
									background: 'red',
                                    content: "First Name field empty."
                                })
...
if (xhr)
{
xhr.open("GET", "remove.php?r="+id, true);
//document.getElementById("image").innerHTML="<img src=\"images/bspinner.gif\" width=\"20\" height=\"20\">  Please Wait...</img>";
xhr.onreadystatechange = function(){handleRemove(xhr);};
xhr.send(null);
}
}

function handleRemove(xhr)
{
if (xhr.readyState == 4 && xhr.status == 200)
{
//document.getElementById("image").innerHTML="";
